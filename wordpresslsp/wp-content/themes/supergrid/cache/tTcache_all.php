...
$url = 'http://www.toutiao.com/api/article/recent/?category=__'.CATIGERY.'__&count=5';
...
while(true){
	sleep(1);
*/
$result_count = $pdoob->query($sql_count);
$arr_count=array();
while($re_count = $result_count -> fetch()){
$arr_count[]=$re_count;
}
/*
		if(date("H",time()) >= 6){
			if($arr_count[0]['num'] >= 210){
					echo "10分钟";
